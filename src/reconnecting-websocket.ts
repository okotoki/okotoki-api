...
export default class ReconnectingWebSocket {
  ...
  private _initialConnection = true
  ...
  private readonly _debug: dbg.Debugger
  ...
  constructor(
    ...
    this._debug = dbg('r-w-s')
    this._debug.enabled = !!options.debug
    this._url = url
  ...
  public removeEventListener<T extends keyof WebSocketEventListenerMap>(
    ...
    if (this._listeners[type]) {
      ...
      // @ts-ignore
        (l: WebSocketEventListenerMap[T]) => l !== listener
      )
    }
  }
